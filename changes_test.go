	...
	for i, test := range []struct {
	...
	}{
		{
			...
			expectedChanges: []string{
				"upload charm cs:nginx",
				"deploy application nginx using cs:nginx",
				"add unit django/$3 to new machine $4",
			...
			expectedChanges: []string{
				"add unit django/$3 to new machine $5",
				"add unit django/$4 to new machine $6",
			...
			expectedChanges: []string{
				...
				"add unit memcached/$1 to new machine $2",
				"add unit memcached/$2 to new machine $3",
				"add unit ror/$0 to new machine $1",
				"add kvm container $3/kvm/$0 on new machine $3",
				"add lxd container $1/lxd/$0 on new machine $1",
				"add lxd container $2/lxd/$0 on new machine $2",
				"add lxd container $3/lxd/$0 on new machine $3",
				"add unit django/$1 to $1/lxd/$0 to satisfy [lxd:memcached]",
				"add unit django/$2 to $2/lxd/$0 to satisfy [lxd:memcached]",
				"add unit django/$3 to $3/lxd/$0 to satisfy [lxd:memcached]",
				"add unit ror/$1 to $3/kvm/$0",
				"add unit ror/$2 to new machine $4",
			},
		}, {
			description: "test placement descriptions for unit placement",
			bundleContent: `
